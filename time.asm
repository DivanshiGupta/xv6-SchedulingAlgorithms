...
int main(int argc, char *argv[]) {
  ...
  51:	53                   	push   %ebx
  52:	56                   	push   %esi
  53:	e8 12 03 00 00       	call   36a <waitx>
        printf(1, "WTIME: %d RUNTIME: %d\n", *rtime, *wtime);
  58:	ff 36                	pushl  (%esi)
  5a:	ff 33                	pushl  (%ebx)
  5c:	68 78 07 00 00       	push   $0x778
  61:	6a 01                	push   $0x1
  63:	e8 b8 03 00 00       	call   420 <printf>
  68:	83 c4 20             	add    $0x20,%esp
  6b:	eb c3                	jmp    30 <main+0x30>
  6d:	66 90                	xchg   %ax,%ax
  6f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb 8f 07 00 00       	mov    $0x78f,%ebx
        while(*s != 0){
