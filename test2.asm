...
int main(int argc, char *argv[]) {
  ...
  12:	c7 45 e8 07 00 00 00 	movl   $0x7,-0x18(%ebp)
  19:	c7 45 ec 00 e1 f5 05 	movl   $0x5f5e100,-0x14(%ebp)
    volatile int x = 0;
  ...
  27:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    id = 0;
  2e:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    for (int k = 0; k < n; k++) {
  35:	8b 45 e8             	mov    -0x18(%ebp),%eax
  38:	85 c0                	test   %eax,%eax
  3a:	7e 75                	jle    b1 <main+0xb1>
  3c:	31 db                	xor    %ebx,%ebx
  3e:	eb 11                	jmp    51 <main+0x51>
        id = fork();
        if (id < 0) {
  ...
  86:	8b 55 f4             	mov    -0xc(%ebp),%edx
  89:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8c:	39 c2                	cmp    %eax,%edx
  8e:	7d 1c                	jge    ac <main+0xac>
  ...
  a5:	8b 45 ec             	mov    -0x14(%ebp),%eax
  a8:	39 c2                	cmp    %eax,%edx
  aa:	7c e4                	jl     90 <main+0x90>
            exit();
  ac:	e8 81 02 00 00       	call   332 <exit>
        }
    }
    for (int k = 0; k < n; k++) {
  b1:	8b 45 e8             	mov    -0x18(%ebp),%eax
  b4:	85 c0                	test   %eax,%eax
  b6:	7e f4                	jle    ac <main+0xac>
  b8:	31 db                	xor    %ebx,%ebx
  ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        wait();
  c0:	e8 75 02 00 00       	call   33a <wait>
    for (int k = 0; k < n; k++) {
  c5:	8b 45 e8             	mov    -0x18(%ebp),%eax
  c8:	83 c3 01             	add    $0x1,%ebx
  cb:	39 d8                	cmp    %ebx,%eax
  cd:	7f f1                	jg     c0 <main+0xc0>
  cf:	eb db                	jmp    ac <main+0xac>
  d1:	66 90                	xchg   %ax,%ax
  d3:	66 90                	xchg   %ax,%ax
  d5:	66 90                	xchg   %ax,%ax
  d7:	66 90                	xchg   %ax,%ax
 ...
 661:	a1 ac 0a 00 00       	mov    0xaac,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 ac 0a 00 00       	mov    %eax,0xaac
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 ac 0a 00 00    	mov    0xaac,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 ac 0a 00 00    	cmp    %eax,0xaac
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 ac 0a 00 00    	mov    0xaac,%edx
 ...
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 ac 0a 00 00 b0 	movl   $0xab0,0xaac
 7b7:	0a 00 00 
 7ba:	c7 05 b0 0a 00 00 b0 	movl   $0xab0,0xab0
 7c1:	0a 00 00 
    base.s.size = 0;
 7c4:	b8 b0 0a 00 00       	mov    $0xab0,%eax
 7c9:	c7 05 b4 0a 00 00 00 	movl   $0x0,0xab4
 7d0:	00 00 00 
